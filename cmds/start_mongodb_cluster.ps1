...
# Script pour demarrer le cluster MongoDB sharde
...
# Shard 1 (rs1)
Write-Host "Demarrage Shard 1 (rs1)..." -ForegroundColor Yellow
...
# Shard 2 (rs2)
Write-Host "Demarrage Shard 2 (rs2)..." -ForegroundColor Yellow
...
# Shard 3 (rs3)
Write-Host "Demarrage Shard 3 (rs3)..." -ForegroundColor Yellow
...
# Mongos
Write-Host "Demarrage Mongos (routeur)..." -ForegroundColor Yellow
...
Write-Host "======================================" -ForegroundColor Green
Write-Host "Cluster MongoDB demarre avec succes!" -ForegroundColor Green
Write-Host "======================================" -ForegroundColor Green
Write-Host "13 fenetres PowerShell ouvertes:" -ForegroundColor Cyan
Write-Host "  - 3 Config Servers (ports 27019-27021)" -ForegroundColor Cyan
Write-Host "  - 9 Shards (rs1, rs2, rs3)" -ForegroundColor Cyan
Write-Host "  - 1 Mongos (port 27018)" -ForegroundColor Cyan
Write-Host "" -ForegroundColor Green
Write-Host "Pour verifier:" -ForegroundColor Yellow
Write-Host "  mongosh --port 27018" -ForegroundColor White
Write-Host "  use ami_politique" -ForegroundColor White
Write-Host "  db.articles.countDocuments()" -ForegroundColor White
